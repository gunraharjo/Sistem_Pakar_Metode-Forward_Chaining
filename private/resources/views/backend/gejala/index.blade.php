  ...
  <div class="row">
    ...
    <div class="col-12">
      <div class="card">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <a href="{{ url('admin/gejala/create', []) }}" class="btn btn-success">Tambah Data</a>
            <hr>
          <table id="example2" class="table table-bordered table-hover" style="width:100%">
            ...
            <tbody>
              ...
              <tr>
                <td>{{$i}}</td>
                <td><a href="{{ url('admin/gejala', ["$item->kode"]) }}">{{$item->kode}}</a></td>
                <td>{{$item->nama_gejala}}</td>
                <td><a href="{{ url('admin/gejala/'.$item->id.'/edit', []) }}"><i style="color:#01307e;"
                      class="fas fa-edit"></i></a></td>
                <td>
                  <form method="POST" action="{{ url('admin/gejala', [$item->id]) }}">
                    @csrf 
                    @method('delete')
